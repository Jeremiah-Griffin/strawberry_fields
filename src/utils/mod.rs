...
mod test {
    ...
    #[test_variants_eq[
        (Zero, YooSixteen::from, YooSixteen::Zero),
        (One, YooSixteen::from, YooSixteen::One),
        (Ten, YooSixteen::from, YooSixteen::Ten),
        (OneHundred, YooSixteen::from, YooSixteen::OneHundred),
